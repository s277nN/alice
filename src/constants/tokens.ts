...
export const testnetTokens: TokenList = {
  ...
  busd: new Token(
    ...
    '0xf900FAc8C13C16AA270bD7E46Cc44D46324845B7',
    18,
    'BUSD',
    'Binance USD',
    'https://www.paxos.com/busd/'
  ...
  xvon: new Token(TESTNET, '0x8fd45fe67984a325e823c091238596984041b9eb', 18, 'XVON', 'XVON Token')
}

export const tokens: TokenList = chian.chianId === ChainId.TESTNET ? testnetTokens : mainnetTokens
